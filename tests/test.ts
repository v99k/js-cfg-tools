import { initCfg, bindCfgTools } from "../src";
...
const cfg = initCfg(
  (tools) => {
    ...
    return {
      ...
      invalidUuidv4: should("uuidv4", "INVALID_UUIDV4", "d18d39a8-a4a0-484b-b676-0798ab3cc333"),
      undefinedUuidv4: should("uuidv4", "UNDEFINED_UUIDV4", "d18d39a8-a4a0-484b-b676-0798ab3cc333"),
    };
  },
  {
    path: ".example.env",
...
console.log(cfg.env, cfg.errors, cfg.warnings);
